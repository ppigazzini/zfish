...
#else
// REPORT-12 B4b: pin the SearchManager::tm offset the default build's zfish_ss_npmsec_advance adds
...
// REPORT-12 TU=0: native default-only (main.zig engineAddOption registers into the native option model).
#ifdef ZFISH_LEGACY_CPP_TARGET
...
// REPORT-12 TU=0 grind: default native (main.zig engineOptionsTextOwner -> zfish_optmodel_render()).
// Legacy keeps the C++ OptionsMap operator<< rendering.
#ifdef ZFISH_LEGACY_CPP_TARGET
