...
// Defaults + BenchmarkPositions vectors. Defaults drives `bench` (its FENs fix the
// bench signature 2067208); BenchmarkPositions drives the `benchmark` command.
...
const BenchmarkPositions = [_][]const []const u8{
    &.{
