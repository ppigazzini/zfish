...
pub var add_main_thread: ?*const fn (pool: *anyopaque, numa_config: *const anyopaque, shared_state: *const anyopaque, update_context: *const anyopaque, thread_id: usize, idx_in_numa: usize, total_numa: usize, numa_id: usize, do_bind: u8) void = null;
pub var add_worker_thread: ?*const fn (pool: *anyopaque, numa_config: *const anyopaque, shared_state: *const anyopaque, thread_id: usize, idx_in_numa: usize, total_numa: usize, numa_id: usize, do_bind: u8) void = null;
