...
fn extendPvSyzygy(ctx: *const PvContext, index: usize, v: i32) i32 {
    ...
    // Hand the LIST over, not a slice of it: the walk appends toward mate and its own
    // termination -- mate, a draw, or the clock -- is the only bound on how far it goes.
