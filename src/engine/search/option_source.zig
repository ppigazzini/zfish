...
//! A caller decides how often a service is asked and the hook cannot tell, so these
...
//!
//! These 4 are SEARCH-AFFECTING when unregistered: they answer rather than abort, so
