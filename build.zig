...
pub fn build(b: *std.Build) void {
    ...
    const module_specs = [_]ModuleSpec{
        ...
        .{ .name = "engine_util", .path = "src/shell/engine_util.zig" },
        .{ .name = "engine_infofmt", .path = "src/shell/engine_infofmt.zig" },
        .{ .name = "engine_nnue", .path = "src/shell/engine_nnue.zig" },
        .{ .name = "engine_trace", .path = "src/shell/engine_trace.zig" },
        .{ .name = "engine_perft", .path = "src/shell/engine_perft.zig" },
        .{ .name = "engine_options", .path = "src/shell/engine_options.zig" },
    ...
    const graph_test = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/shell/engine_graph.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    for ([_]DepTest{
        ...
        .{ .path = "src/shell/engine_infofmt.zig", .deps = &.{"engine_util"} },
        .{ .path = "src/shell/engine_options.zig", .deps = &.{"option"} },
