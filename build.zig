...
pub fn build(b: *std.Build) void {
    ...
    // identical 178,029-node tree, bit-exact (the bench signature was unmoved): 4,065,662,391 ->
    ...
    // only ran on Linux. Default to the 1648567 arch/OS invariant; -Dsignature-ref overrides.
    const signature_reference = signature_ref orelse "1648567";
    ...
    // (== 1648567) and the GOLDEN gates (output-golden / perft / eval-trace / misc /
    ...
    // same 1648567 the signature checks.
    ...
    // Reuse the same harness `signature_cmd` `parity` uses for the bench signature (1648567 invariant).
