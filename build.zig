...
pub fn build(b: *std.Build) void {
    ...
    const module_specs = [_]ModuleSpec{
        ...
        .{ .name = "limits_type", .path = "src/board/limits_type.zig" },
        .{ .name = "root_move", .path = "src/support/root_move.zig" },
        ...
        .{ .name = "engine_util", .path = "src/support/engine_util.zig" },
        .{ .name = "engine_infofmt", .path = "src/support/engine_infofmt.zig" },
        .{ .name = "engine_nnue", .path = "src/support/engine_nnue.zig" },
        .{ .name = "engine_trace", .path = "src/support/engine_trace.zig" },
        .{ .name = "engine_perft", .path = "src/support/engine_perft.zig" },
        .{ .name = "engine_options", .path = "src/support/engine_options.zig" },
        ...
        .{ .name = "tt_types", .path = "src/support/tt_types.zig" },
        ...
        .{ .name = "uci_strings", .path = "src/uci/uci_strings.zig" },
        .{ .name = "uci_format", .path = "src/uci/uci_format.zig" },
        .{ .name = "uci_parse", .path = "src/uci/uci_parse.zig" },
        .{ .name = "evaluate", .path = "src/eval/evaluate.zig" },
        .{ .name = "nnue_accumulator", .path = "src/eval/nnue_accumulator.zig" },
        .{ .name = "nnue_acc_rowops", .path = "src/eval/nnue_acc_rowops.zig" },
        .{ .name = "nnue_ft", .path = "src/eval/nnue_ft.zig" },
        .{ .name = "nnue_refresh_cache", .path = "src/eval/nnue_refresh_cache.zig" },
        ...
        .{ .name = "correction_bundle", .path = "src/board/correction_bundle.zig" },
        .{ .name = "shared_history_types", .path = "src/board/shared_history_types.zig" },
        .{ .name = "search_ctx", .path = "src/board/search_ctx.zig" },
        .{ .name = "search_id", .path = "src/board/search_id.zig" },
        .{ .name = "search_acc", .path = "src/board/search_acc.zig" },
        .{ .name = "search_setup", .path = "src/board/search_setup.zig" },
        .{ .name = "search_driver", .path = "src/board/search_driver.zig" },
        .{ .name = "search_emit", .path = "src/board/search_emit.zig" },
        .{ .name = "position_lifecycle", .path = "src/board/position_lifecycle.zig" },
    ...
    for ([_]DepTest{
        ...
        .{ .path = "src/eval/nnue_acc_update.zig", .deps = &.{ "position_snapshot", "position_types", "nnue_feature", "nnue_acc_rowops", "nnue_ft", "nnue_refresh_cache" } },
        ...
        .{ .path = "src/support/movepick_history.zig", .deps = &.{"position_snapshot"} },
        ...
        .{ .path = "src/eval/nnue_weight_storage.zig", .deps = &.{"memory"} },
        .{ .path = "src/eval/nnue_inference.zig", .deps = &.{ "nnue_accumulator", "position_types", "memory" } },
        ...
        .{ .path = "src/board/move_do.zig", .deps = &.{ "bitboard", "board_core", "legality", "position_types", "state_setup", "zobrist" } },
