...
pub fn build(b: *std.Build) void {
    ...
    // identical 178,029-node tree, bit-exact (bench stays 2508687): 4,065,662,391 ->
    ...
    // only ran on Linux. Default to the 2508687 arch/OS invariant; -Dsignature-ref overrides.
    ...
    // (== 2508687) and the GOLDEN gates (output-golden / perft / eval-trace / misc /
    ...
    // Reuse the same harness `signature_cmd` `parity` uses for the bench signature (2508687 invariant).
