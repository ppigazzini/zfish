...
ROWS=(
    ...
    # searches a different tree, so the bench total moves off 2508687.
    "signature|src/engine/search/search.zig|    return 483 + 318 * depth * depth;|    return 484 + 318 * depth * depth;|razor margin 483->484"
