...
//     run bench and assert `Nodes searched` == expected (the 2508687 arch/OS invariant).
...
// (16/1/depth-13 -> 2508687) never exercises. Verify equal to the pristine upstream oracle
...
// signature: assert bench reports the exact node count (the 2508687 arch/OS invariant).
