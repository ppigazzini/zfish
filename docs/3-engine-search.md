...
[1-architecture.md](1-architecture.md); for the leaf evaluation, see
[4-engine-eval.md](4-engine-eval.md); for move generation and legality, see
[2-engine-board.md](2-engine-board.md).
