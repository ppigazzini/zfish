...
[01-architecture.md](01-architecture.md); for what the shell drives, see
[03-engine-search.md](03-engine-search.md), [04-engine-eval.md](04-engine-eval.md), and
[07-platform.md](07-platform.md).
...
| `SyzygyPath` | re-init the tablebases and report what was found ([06-tablebases.md](06-tablebases.md)) |
...
drives is described in [05-multithreading.md](05-multithreading.md).
